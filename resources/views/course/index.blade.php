                    ...
                    <div class="col-12 d-flex justify-content-between">
                        @can('create course')
                            <div class="col-3 d-flex justify-content-start">
                                <button data-url="{{ route('create.course') }}" id="btn-open-create"
                                    data-modal-title="Create course Form" class="btn btn-primary">Create course</button>
                            </div>
                        @endcan
            ...
            @foreach ($courses as $index => $course)
                <tr>
                    ...
                    <td>
                        ...
                        @can('remove course')
                            <button class="btn btn-danger" id="btn-remove" data-remove-id="{{ $course->id }}"
